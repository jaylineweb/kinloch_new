...
<div id="wrap">
    ...
    <section id="content">
        ...
        <article id="model">
            ...
            <div id="left">
                <p class="model1">
                    <a href="/kinloch/img/lookbook01_big01.jpg" title="" class="fresco" data-fresco-group="model1" data-content="model1">
            ...
            <div id="right">
                <p class="model2">
                    <a href="/kinloch/img/look(small)2.jpg" title="model2" class="fresco" data-fresco-group="model1" data-content="model1">
                        <img src="/kinloch/img/look(small)2.jpg" alt="model2">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
                ...
                <p class="model3">
                    <a href="/kinloch/img/look(small)3.jpg" title="model3" class="fresco" data-fresco-group="model1" data-content="model1">
                        <img src="/kinloch/img/look(small)3.jpg" alt="model3">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
                ...
                <p class="model4">
                    <a href="/kinloch/img/look(small)4.jpg" title="model" class="fresco" data-fresco-group="model1" data-content="model1">
                        <img src="/kinloch/img/look(small)4.jpg" alt="model4">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
                ...
                <p class="model5">
                    <a href="/kinloch/img/look(small)5.jpg" title="model" class="fresco" data-fresco-group="model1" data-content="model1">
                        <img src="/kinloch/img/look(small)5.jpg" alt="model5">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
                    <span class="rightBottomW"></span></p>
                <p class="model6">
                    <a href="/kinloch/img/look(small)6.jpg" title="model" class="fresco" data-fresco-group="model1" data-content="model1">
                        <img src="/kinloch/img/look(small)6.jpg" alt="model6">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
                ...
                <p class="model7">
                    <a href="/kinloch/img/look(small)7.jpg" title="model" class="fresco" data-fresco-group="model1" data-content="model1">
                        <img src="/kinloch/img/look(small)7.jpg" alt="model7">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
        ...
        <article id="model2">
            ...
            <div id="left2">
                <p class="model8">
                    <a href="/kinloch/img/style8.jpg" title="" class="fresco" data-fresco-group="model2" data-content="model2">
                        <img src="/kinloch/img/style8.jpg" alt="model8">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
                ...
                <p class="model9">
                    <a href="/kinloch/img/style9.jpg" title="model9" class="fresco" data-fresco-group="model2" data-content="model2">
                        <img src="/kinloch/img/style9.jpg" alt="model9">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
                ...
                <p class="model10">
                    <a href="/kinloch/img/style10.jpg" title="model10" class="fresco" data-fresco-group="model2" data-content="model2">
                        <img src="/kinloch/img/style10.jpg" alt="model10">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
                ...
                <p class="model11">
                    <a href="/kinloch/img/style11.jpg" title="model11" class="fresco" data-fresco-group="model2" data-content="model2">
                        <img src="/kinloch/img/style11.jpg" alt="model11">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
                ...
                <p class="model12">
                    <a href="/kinloch/img/style12.jpg" title="model12" class="fresco" data-fresco-group="model2" data-content="model2">
                        <img src="/kinloch/img/style12.jpg" alt="model12">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
                ...
                <p class="model13">
                    <a href="/kinloch/img/style13.jpg" title="model13" class="fresco" data-fresco-group="model2" data-content="model2">
                        <img src="/kinloch/img/style13.jpg" alt="model13">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
            ...
            <div id="right2">
                <p class="model14">
                    <a href="/kinloch/img/lookbook02_big14.jpg" title="model" class="fresco" data-fresco-group="model3" data-content="model3">
                        <img src="/kinloch/img/lookbook02_big14.jpg" alt="model14">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
        ...
        <!--<article id="model3">
            ...
            <div id="left3">
                <p class="model15">
                    <a href="/kinloch/img/lookbook02_big15.jpg" title="" class="fresco" data-fresco-group="model3" data-content="model3">
                        <img src="/kinloch/img/lookbook02_big15.jpg" alt="model1">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
            ...
            <div id="right3">
                <p class="model16">
                    <a href="/kinloch/img/style16.jpg" title="model16" class="fresco" data-fresco-group="model3" data-content="model2">
                        <img src="/kinloch/img/style16.jpg" alt="model16">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
                ...
                <p class="model17">
                    <a href="/kinloch/img/style17.jpg" title="model17" class="fresco" data-fresco-group="model3" data-content="model2">
                        <img src="/kinloch/img/style17.jpg" alt="model17">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
                ...
                <p class="model18">
                    <a href="/kinloch/img/style18.jpg" title="model18" class="fresco" data-fresco-group="model3" data-content="model2">
                        <img src="/kinloch/img/style18.jpg" alt="model18">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
                ...
                <p class="model19">
                    <a href="/kinloch/img/style19.jpg" title="model19" class="fresco" data-fresco-group="model3" data-content="model2">
                        <img src="/kinloch/img/style19.jpg" alt="model5">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
                ...
                <p class="model20">
                    <a href="/kinloch/img/style20.jpg" title="model20" class="fresco" data-fresco-group="model3" data-content="model2">
                        <img src="/kinloch/img/style20.jpg" alt="model20">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
                ...
                <p class="model21">
                    <a href="/kinloch/img/style21.jpg" title="model21" class="fresco" data-fresco-group="model3" data-content="model2">
                        <img src="/kinloch/img/style21.jpg" alt="model21">
                    </a>
                    <span class="leftTopH"></span>
                    <span class="rightBottomH"></span>
                    <span class="leftTopW"></span>
